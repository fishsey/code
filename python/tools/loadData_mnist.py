...
abPath = "/root/AAA/"  
#abPath = "D:/baiduYun/syn/Github/"  
def mainWithLabelEnocde():
    '''
    x: (60000, 784)
    y: (60000, 10)
    tx: (10000, 784)
    ...
    trainfile_X = abPath + 'dataset/mnist/train-images-idx3-ubyte'
    trainfile_y = abPath + 'dataset/mnist/train-labels-idx1-ubyte'
    testfile_X = abPath + 'dataset/mnist/t10k-images-idx3-ubyte'
    testfile_y = abPath + 'dataset/mnist/t10k-labels-idx1-ubyte'
