...
def createCoOccurrenceMatrixByDBSCAN(fileName, eps, min_samples, ws):
    import numpy as np
...
#                    print eps, min_samples
                    saveFile = "/root/AAA/dataset/qos/tp/coOccurrenceMatrix-%s-%d-%d-%d-%d" % (side, sparess, fileNum, eps, min_samples)
                    wsCoo = createCoOccurrenceMatrixByDBSCAN(trainFile, eps, min_samples, ws=ws)
