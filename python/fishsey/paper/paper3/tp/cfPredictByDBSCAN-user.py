        ...
        for fileNum in range(1, 2):
            ...
            for eps in [1]:
                for min_samples in [1]:
                    ...
                    userSimFile = "/root/AAA/dataset/qos/tp/coOccurrenceMatrix-%s-%d-%d-%d-%d" % (side, sparess, fileNum, eps, min_samples)
                    ...
                    np.savetxt("/root/AAA/dataset/qos/tp/pui/dbscanPui-user-%d-%d" % (sparess, fileNum), pui, fmt='%f', delimiter='\t')
