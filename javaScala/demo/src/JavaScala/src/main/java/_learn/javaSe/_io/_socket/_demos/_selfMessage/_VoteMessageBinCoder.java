...
public class _VoteMessageBinCoder implements _VoteMessageCoder
{
    ...
    public _VoteMessage decoder(byte[] input) throws IOException
    {
        // sanity checks
        ...
        return new _VoteMessage(resp, inq, candidateID, count);
    }
}  
