...
package tools.apache.mahout.slopeone;
...
public final class SlopeOneRecommender extends AbstractRecommender
{
    ...
    public SlopeOneRecommender(DataModel dataModel, int flag) throws TasteException
    {
  
        //if flag is -1, use no weighted
        //if flag is not -1, use numCountWeighted
        this(dataModel,
                flag == -1 ? Weighting.UNWEIGHTED : Weighting.WEIGHTED,
                Weighting.UNWEIGHTED,
                new MemoryDiffStorage(dataModel, Weighting.UNWEIGHTED, Long.MAX_VALUE));
    }
