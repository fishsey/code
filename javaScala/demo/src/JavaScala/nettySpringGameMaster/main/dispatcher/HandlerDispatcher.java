package _temp._netty._nettySpringGameMaster.main.dispatcher;
...
import _temp._netty._nettySpringGameMaster.main.domain.MessageQueue;
import _temp._netty._nettySpringGameMaster.main.handler.GameHandler;
import _temp._netty._nettySpringGameMaster.main.utils.ExceptionUtils;
import _temp._netty._nettySpringGameMaster.main.utils.HttpUtils;
...
public class HandlerDispatcher implements Runnable
{
    ...
    public void removeMessageQueue(Integer channelId)
    {
        MessageQueue queue = (MessageQueue) this.sessionMsgQ.remove(channelId);
        if (queue != null)
            queue.clear();
    }
