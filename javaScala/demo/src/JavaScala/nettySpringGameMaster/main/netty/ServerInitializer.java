package _temp._netty._nettySpringGameMaster.main.netty;

import _temp._netty._nettySpringGameMaster.main.dispatcher.HandlerDispatcher;
...
public class ServerInitializer extends ChannelInitializer<SocketChannel>
{
    ...
    public void initChannel(SocketChannel ch) throws Exception
    {
        ...
        {
            ch.pipeline().addLast("frameDecoder", new LengthFieldBasedFrameDecoder(Integer.MAX_VALUE, 0, 4, 0, 4));//decoder
            ch.pipeline().addLast("frameEncoder", new LengthFieldPrepender(4)); //MessageToByteEncoder<ByteBuf>
        } else
        {
