...
public class BaiduMoGuZheng
{
    public static void main(String args[])
    {
        ...
        while (cin.hasNext())
        {
            ...
            System.out.printf("%.2f\n", getProb(flag, new int[]{0, 0}));
        }

    }

    private static double getProb(int[][] flag, int[] start)
    {
        int n = flag.length - 1;
         ...
         if (start[0] + 1 <= n && start[1] + 1 > m)
        {
            if (flag[start[0]+1][start[1]] == 1)
                ...
                return  getProb(flag, new int[]{start[0]+1, start[1]});
        ...
        }else if (start[1] + 1 <= m && start[0] + 1 > n)
        {
            if (flag[start[0]][start[1]+1] == 1)
                ...
                return getProb(flag, new int[]{start[0], start[1]+1});
        }else if (start[0] + 1 <= n && start[1] + 1 <= m)
         {
             if (flag[start[0]+1][start[1]] == 1 && flag[start[0]][start[1]+1] == 1)
                 return 0;
             else if (flag[start[0]+1][start[1]] == 1)
                 return 0.5 * getProb(flag, new int[]{start[0], start[1]+1});
             else if (flag[start[0]][start[1]+1] == 1)
                 return 0.5 * getProb(flag, new int[]{start[0]+1, start[1]});
             else
                 return 0.5 * getProb(flag, new int[]{start[0]+1, start[1]}) + 0.5 * getProb(flag, new int[]{start[0], start[1]+1});
