...
public abstract class AbstractGraph<V> implements Graph<V>
{
     ...
     * edges shape is n*2(n is the number of edge, 2 is (u, v)), edge is directed
     */
    ...
    public int[][] getAdjacencyMatrix()
    {
        ...
        {
            for (int i1 = 0; i1 < adjacencyMatrix[0].length; i1++)
            {
    ...
    public Tree dfs(int v)
    {
        ...
        // Mark visited vertices and init to false
